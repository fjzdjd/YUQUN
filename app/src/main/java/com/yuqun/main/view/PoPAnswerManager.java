...
public class PoPAnswerManager {
	private PopupWindow pop;
	private View popView;
	private static volatile PoPAnswerManager instance;
	List<String> data = new ArrayList<String>();
	public Context context;

	public PoPAnswerManager() {
	}
	 ...
	 */
	public static PoPAnswerManager getInstance() {
		if (instance == null) {
			instance = new PoPAnswerManager();
		}
		return instance;
	}
	...
	public View setPopView(Context context, int id) {
		if (popView == null) {
			...
			popView.findViewById(R.id.pop_close).setOnClickListener(
					new OnClickListener() {
	...
	public ListView4ScrollView getListView(){
		ListView4ScrollView lvsv = (ListView4ScrollView) popView.findViewById(R.id.lvsv);
		return lvsv;
	}
}
