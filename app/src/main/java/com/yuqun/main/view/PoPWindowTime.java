...
import com.yuqun.main.component.PickerView;

/**
 * 显示带有pickview 的 popWindow
 * 
 * @author Administrator
 * 
 */
public class PoPWindowTime {
	private PopupWindow pop;
	private View popView;
	public PickerView pickerView1;
	private static volatile PoPWindowTime instance;
	List<String> data = new ArrayList<String>();
	public Context context;
	private View p;

	private PoPWindowTime() {
	}
	 ...
	 */
	public static PoPWindowTime getInstance() {
		if (instance == null) {
			instance = new PoPWindowTime();
		}
		return instance;
	}
...
/*	public void changeOkBtnOnClick(OnClickListener onClickListener) {
	 ...
	 * @param data4
	 */
	public void setPickViewData(List<String> data1) {
		if (pickerView1 == null) {
			pickerView1 = (PickerView) popView.findViewById(R.id.pv);
		}
		pickerView1.setData(data1);
		pickerView1.setSelected(1);
