 ...
 * 用户协议
 */
public class PoPXieYiManager {
	private PopupWindow pop;
	private View popView;
	private static volatile PoPXieYiManager instance;
	List<String> data = new ArrayList<String>();
	public Context context;

	public PoPXieYiManager() {
	}
	 ...
	 */
	public static PoPXieYiManager getInstance() {
		if (instance == null) {
			instance = new PoPXieYiManager();
		}
		return instance;
	}
