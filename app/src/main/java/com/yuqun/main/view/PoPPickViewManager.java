...
public class PoPPickViewManager {
	private PopupWindow pop;
	private View popView;
	private static volatile PoPPickViewManager instance;
	List<String> data = new ArrayList<String>();
	public Context context;

	public PoPPickViewManager() {
	}
	 ...
	 */
	public static PoPPickViewManager getInstance() {
		if (instance == null) {
			instance = new PoPPickViewManager();
		}
		return instance;
	}
