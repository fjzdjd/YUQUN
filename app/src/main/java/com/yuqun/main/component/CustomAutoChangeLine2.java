...
public class CustomAutoChangeLine2 extends ViewGroup {
	 ...
	 * @param defStyle
	 */
	public CustomAutoChangeLine2(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * @param attrs
	 */
	public CustomAutoChangeLine2(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
