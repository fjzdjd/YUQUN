...
public class CustomAutoChangeLineIndex extends ViewGroup {
     ...
     * @param context
     */
    public CustomAutoChangeLineIndex(Context context) {
        super(context);
    }
     ...
     * @param defStyle
     */
    public CustomAutoChangeLineIndex(Context context, AttributeSet attrs, int defStyle) {
     ...
     * @param attrs
     */
    public CustomAutoChangeLineIndex(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int autualWidth = r - l;
//        int x = SIDE_MARGIN;// 横坐标开始  修改主界面tags需要
        int x = 0;// 横坐标开始
        int y = 0;// 纵坐标开始
        int rows = 1;
