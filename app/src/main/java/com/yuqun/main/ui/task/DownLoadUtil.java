...
public class DownLoadUtil {
     ...
     * 设置TextView的html显示
     */
    public static void setHtmlText(final TextView textView, final String html, final int
            imgWidth, final int imgHeight) {
        /**
         * 创建下载路径
         */
        ...
        final Html.ImageGetter imageGetter = new Html.ImageGetter() {
            ...
            public Drawable getDrawable(String s) {
                ...
                File filePath = new File(Environment.getExternalStorageDirectory().getPath() +
                        DOWNLOAD_DIR + "/" + String.valueOf(s.hashCode()) + ".jpg");
                if (filePath.exists()) {
                    //文件存在
    ...
    public static void setImageWithCache(final ImageView imageView, String url) {
        ...
        final File filePath = new File(Environment.getExternalStorageDirectory().getPath() +
                CACHE_DIR + "/" + String.valueOf(url.hashCode()) + ".jpg");
        if (filePath.exists()) {
            //文件存在
