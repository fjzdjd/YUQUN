...
public class ZoomBeingTutorial {
	...
	public ZoomBeingTutorial(View containerView, View expandedView) {
...
//		int firstPosition = ((AdapterView<?>)mThumbViewParent).getFirstVisiblePosition();
		...
		mContainView.findViewById(R.id.task_being_rlt_cancel_task).getGlobalVisibleRect(finalBounds, globalOffset);
		startBounds.offset(-globalOffset.x, -globalOffset.y);
		finalBounds.offset(-globalOffset.x, -globalOffset.y);
		//设置比率
		set_Center_crop(finalBounds);
