 ...
 */
public class Reg2ReveneAdapter extends BaseAdapter {
    private List<RevenueModel> mFoundsList= new ArrayList<RevenueModel>();
    private Context context;

    public Reg2ReveneAdapter(List<RevenueModel> mFoundsList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv_city_name.setText(mFoundsList.get(position).getRangeName());
        return convertView;
    }
}
